...
{
    public class DCMiscIssueFragment : CSIBaseDialogFragment
    {
        ...
        public DCMiscIssueFragment() : base()
        {
        }

        public DCMiscIssueFragment(CSIBaseActivity activity = null) : base(activity)
        {
            Title = Application.Context.GetString(Resource.String.MiscIssue);
        ...
        private bool ValidateReason()
        {
            if (!ReasonValidated)
            {
                ...
                else
                {
                    ...
                    ReasonValidated = CSIReasons.GetReason(CSISystemContext, ref ReasonCode, "MISC ISSUE", ref ReasonDescription);
                    if (ReasonValidated)
                    {
