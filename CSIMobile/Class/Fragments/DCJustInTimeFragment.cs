...
{
    public class DCJustInTimeFragment : CSIBaseDialogFragment
    {
        CSIDcjms SLDcjms;
        ...
        public DCJustInTimeFragment() : base()
        {
        ...
        public static void RunFragment(CSIBaseActivity activity)
        {
            try
            {
                ...
                DCJustInTimeFragment JustInTimeDialog = (DCJustInTimeFragment)activity.FragmentManager.FindFragmentByTag("JobReceipt");
                if (JustInTimeDialog != null)
                {
                    ft.Show(JustInTimeDialog);
                    //ft.AddToBackStack(null);
                }
                else
                {
                    // Create and show the dialog.
                    JustInTimeDialog = new DCJustInTimeFragment(activity);
                    //Add fragment
                    JustInTimeDialog.Show(ft, "JobReceipt");
                }
            }
            catch (Exception Ex)
            {
